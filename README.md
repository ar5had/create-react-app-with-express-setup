...
This repository is clone of [fullstackreact/food-lookup-demo](https://github.com/fullstackreact/food-lookup-demo) with some changes. Extra code has been removed, moongoose and some other modules are added.

### Detailed blog post

Here is a [detailed blog post](https://www.fullstackreact.com/articles/using-create-react-app-with-a-server/) that explains this repository.
